                ...
                <a href="{{ route('front.details', $itemNewWorkshop->slug) }}" class="card">
                    <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                            ...
                            <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                                ...
                                @if ($itemNewWorkshop->is_open)
                                    ...
                                    <div class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1        bg-aktiv-orange text-white z-10">
                                        <img src="{{asset('assets/images/icons/timer-star.svg')}}" class="w-6 h-6" alt="icon">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <img src="{{asset('assets/images/icons/arrow-right.svg')}}" class="w-12 h-12 flex shrink-0"
                                alt="icon">
                        </div>
                    </div>
                </a>
                @empty
                    <h3>Belum Ada Data Workshop Terbaru</h3>
                @endforelse
            </div>
        </div>
    </section>
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="flex h-full w-[436px] shrink-0 bg-aktiv-orange overflow-hidden">
                                    <img src="{{asset('assets/images/photos/testimony1.png')}}" class="w-full h-full object-cover"
                                        alt="photo">
                                </div>
                                <div
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex items-center">
                                            <img src="{{asset('assets/images/icons/Star 1.svg')}}" class="p-[5px] w-8 h-8"
                                                alt="star">
                                            <img src="{{asset('assets/images/icons/Star 1.svg')}}" class="p-[5px] w-8 h-8"
                                                alt="star">
                                            <img src="{{asset('assets/images/icons/Star 1.svg')}}" class="p-[5px] w-8 h-8"
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="{{asset('assets/images/icons/Tangible Results.png')}}" class="flex w-[56px] h-[56px] shrink-0"
                                alt="icon">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="{{asset('assets/images/icons/community support.png')}}" class="flex w-[56px] h-[56px] shrink-0"
                                alt="icon">
